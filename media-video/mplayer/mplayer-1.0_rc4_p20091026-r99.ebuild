...
# $Header: /var/cvsroot/gentoo-x86/media-video/mplayer/mplayer-1.0_rc4_p20091026-r1.ebuild,v 1.21 2010/11/07 19:37:38 anarchy Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${P}-expands-properties-on-run-slave-mode-command.patch
}
...
src_configure() {
	...
	use svga || myconf="${myconf} --disable-svga --disable-svgalib_helper"
